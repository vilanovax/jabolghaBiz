  ...
  return (
    <div className="fixed inset-0 z-[70] pointer-events-none">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="animate-levelup-pop text-center">
          <div
          ...
          {hint && (
            <p className="text-xs font-bold text-white/70 mt-1.5 drop-shadow-lg">{hint}</p>
          )}
        </div>
      </div>
    </div>
